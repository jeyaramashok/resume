...
\resumeItem{CloudPak Engineering}
{
    \begin{itemize}[leftmargin=*]
        ...
        \item Developed kuberenetes controller for Redis database, which was used as shared dependency across IBM CloudPaks.
        \item Developed general-purpose service broker operator (using OSB API).
