...
\resumeItem{CloudPak Engineering}
{
    \begin{itemize}[leftmargin=*]
        \item Responsible for making IBM CloudPaks work consistently in RedHat OpenShift (RHOCP) in hybrid cloud.
        \item Developed Kubernetes controller for Redis database, which was used as shared dependency across IBM CloudPaks.
        ...
        \item Implemented code signing and image signing for IBM CloudPak content pipeline, to ensure the integrity and avoid supply chain attacks.
        \item Helped develop certification service containing security best practices and patterns that IBM products must adhere to when developing production grade applications on Kubernetes.
