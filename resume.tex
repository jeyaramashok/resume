...
I am a software engineer at IBM where I build kubernetes operators and developer tools.
...
\resumeItem{CloudPak Engineering}
{
    \begin{itemize}[leftmargin=*]
        \item Responsible for certification and delivery of IBM CloudPaks on RedHat OpenShift (RHOCP).
        \item Developed Kubernetes controller for Redis database, used as shared dependency across IBM CloudPaks.
        ...
        \item Developed internal developer tools (CLI) for packaging and delivering IBM CloudPaks.
        \item Implemented code \& image signing for our pipeline, to ensure integrity and avoid supply chain attacks.
